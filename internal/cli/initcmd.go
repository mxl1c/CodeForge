...
Seat:    ~/.codeforge/seat.json via "codeforge seat trial|activate|suspend|status"`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			cmd.Printf("seat ledger: ~/.codeforge/seat.json  (codeforge seat trial|activate|suspend|status)\n")
